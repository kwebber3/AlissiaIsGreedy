...
for index, eachRow in AllData.iterrows():
    ...
    if currentProtein not in Proteins_Included and currentSequence not in Sequences_Included:
        Proteins_Included.append(currentProtein)
        Sequences_Included.append(currentSequence)
    ...
    elif currentProtein not in Proteins_Full and currentSequence not in Sequences_Included:
        Sequences_Included.append(currentSequence)
